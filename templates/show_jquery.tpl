    ...
    <div class="row">
        <div class="a col-lg-12 col-lg-offset-0">
            ...
            <div class="row frame grid-divider">
                ...
                <div class="a col-lg-8 col-lg-offset-0">
                    <h3>Structure:
                        <button type="button" class="btn btn-danger pull-right" id="btn-collapse-all">Collapse All Folders
                        </button>
                ...
                <div id="navigation_tree" class="a col-lg-4 col-xs-offset-0">
                    <div class="col-padding">
                        ...
                        <b>Rename file: <span id="selected_file" class="selected_file"></span></b> <br>
